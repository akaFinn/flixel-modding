...
class FlxModding
{
	 ...
	 */
	public static inline var hScriptExt:String = flixel.util.FlxModUtil.getDefinedString("FLX_HSCRIPT_EXT", ".hxs");

	/**
	 * File extension used for Polymod script classes.
	 */
	public static inline var polymodScriptExt:String = flixel.util.FlxModUtil.getDefinedString("FLX_POLYMOD_SCRIPT_EXT", ".hxc");

	/**
	 * File extension used for RuleScript classes.
	 */
	public static inline var ruleScriptExt:String = flixel.util.FlxModUtil.getDefinedString("FLX_RULESCRIPT_EXT", '.rhx');
